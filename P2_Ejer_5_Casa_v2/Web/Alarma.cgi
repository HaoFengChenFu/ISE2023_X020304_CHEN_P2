...
t <form action="Alarma.cgi" method="post" name="AlarmaRTC">
...
#
t  <th width=100%>Configuracion de la alarma </th> </tr>
#t <td align="center"><input type="text" readonly style="background-color: transparent; border: 0px"
t </font></table>
t <p align=left>
t <form>
t <input type="radio" id="AlarmHab" name=AlarmaHab value = "1">
t <label for="habilitacion">Habilitar Alarma</label><br>
t <input type="radio" id="AlarmDeshab" name=AlarmaHab value = "0">
t <label for="habilitacion">Desabilitar Alarma</label><br>
t <br><br><label for="horaAlarma">Elige las Horas (Entre 0 y 23):</label>
t <input type="number" id="horaAlarma" name="horaAlarma" min="0" max="23">
t <br><br><label for="minutoAlarma">Elige los Minutos (Entre 0 y 59):</label>
